export default class Album {
  ...
  init() {
    ...
    artwork.append(artworkImageAlt);
    this._parentElement.append(artwork);
  }

  setPositionAlt(h, v) {
    this._artworkImageAlt.classList.add("active");
    this._artworkImageAlt.setAttribute("data-artwork-sprite", `${h},${v}`);
    this._artworkImageAlt.addEventListener(
      "transitionend",
  ...
  setPosition(h, v) {
    ...
    this._artworkImageAlt.removeEventListener("transitionend", () =>
      this.setPosition(h, v)
    );
  }
}
